...
export default function Hero() {
  ...
  const followersCount = useCountUp(1400, 2000, started)
  ...
  const statItems = [
    ...
    { value: 'Round 2', sub: 'USAII Hackathon' },
    { value: followersCount >= 1000 ? `${(followersCount / 1000).toFixed(1)}k+` : `${followersCount}+`, sub: 'Followers' },
  ]
    ...
    <section className="min-h-screen flex items-center relative overflow-hidden bg-brand-bg">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <motion.h1
            variants={prefersReducedMotion ? {} : itemVariants}
            className="font-display font-bold gradient-text leading-[1.05]"
            style={{ fontSize: 'clamp(2.8rem, 7vw, 5rem)', fontFamily: 'Space Grotesk, sans-serif' }}
          >
            Kaneeza Batool
          </motion.h1>
          ...
          >
            <span className="text-brand-violet-light text-lg">{displayText}</span>
            <span className="text-brand-violet text-lg ml-0.5" style={{ animation: 'blink 1s step-end infinite' }}>|</span>
          </motion.div>
          ...
          {/* Stats row */}
          <motion.div variants={prefersReducedMotion ? {} : itemVariants} className="flex flex-wrap items-center gap-5">
            {statItems.map((stat, i) => (
              <div key={stat.sub} className="flex items-center gap-5">
                <div className="flex flex-col items-start">
                  ...
                  <span className="section-label mt-0" style={{ fontSize: '0.65rem', marginBottom: 0 }}>
                    {stat.sub}
                  </span>
                </div>
          ...
          {/* Social links */}
          <motion.div variants={prefersReducedMotion ? {} : itemVariants} className="flex items-center gap-5">
            {[
        ...
        >
          <div className="relative flex items-center justify-center">
            ...
            <img
              ...
              loading="eager"
              decoding="async"
              className="w-56 h-56 lg:w-72 lg:h-72 object-cover relative z-10"
              style={{
                borderRadius: '9999px',
            ...
            >
              <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', color: '#60A5FA' }}>
                Stanford CIP '26
              </span>
            </div>
            ...
            <div
              ...
              className="glass px-3 py-2 rounded-xl whitespace-nowrap"
            >
              <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', color: '#34D399' }}>
                USAII Round 2
              </span>
            </div>
            ...
            <div
              ...
              className="glass px-3 py-2 rounded-xl whitespace-nowrap"
            >
              <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', color: '#FBBF24' }}>
                HEC Top Performer
              </span>
            </div>
          </div>
